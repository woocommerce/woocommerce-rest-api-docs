...
| `include_status`  | string  | Limit result set to products with any of the specified statuses. Options: `any`, `trash`, `draft`, `pending`, `private`, and `publish`.|
| `exclude_status`  | string  | Exclude products with any of the statuses from result set. Options: `trash`, `draft`, `pending`, `private`, and `publish`.|
| `type`            | string  | Limit result set to products assigned a specific type. Options: `simple`, `grouped`, `external` and `variable`.       |
| `include_types`   | string  | Limit result set to products with any of the types. Options: `simple`, `grouped`, `external` and `variable`.                                                           |
| `exclude_types`   | string  | Exclude products with any of the types from result set. Options: `simple`, `grouped`, `external` and `variable`.                                                           |
