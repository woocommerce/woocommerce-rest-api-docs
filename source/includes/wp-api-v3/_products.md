...
| `exclude_status`  | string  | Exclude products with any of the statuses from result set. Multiple statuses can be provided as a comma-separated list. Options: `trash`, `draft`, `pending`, `private`, and `publish`.|
...
| `exclude_types`   | string  | Exclude products with any of the types from result set. Multiple statuses can be provided as a comma-separated list. Options: `simple`, `grouped`, `external` and `variable`.                                                           |
