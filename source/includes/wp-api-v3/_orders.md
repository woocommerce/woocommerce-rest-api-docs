...
| `can_be_refunded`     | boolean   | Whether the order can be refunded, based on its status and remaining refundable amount. Available as of WooCommerce 11.1.0. <i class="label label-info">read-only</i> |
...
| `can_be_refunded` | boolean | Whether this line has remaining refundable quantity or amount. Available as of WooCommerce 11.1.0. <i class="label label-info">read-only</i> |
